...
var getValFromEvent = function getValFromEvent(_ref) {
  ...
  return _objectSpread2({}, detail, {}, currentTarget.dataset);
};
/**
...
var def = function def(key) {
  return function (_ref2) {
    ...
    return function (target) {
      Object.defineProperty(target, key, _objectSpread2({
        value: value,
...
function () {
  ...
  _createClass(VmStatus, [{
    ...
    value: function updateState(_ref2) {
      ...
      this.newStateByVM = _objectSpread2({}, this.newStateByVM, _defineProperty({}, key, _objectSpread2({}, this.newStateByVM[key], _defineProperty({}, path, newVal))));
      this.oldStateByVM = _objectSpread2({}, this.oldStateByVM, _defineProperty({}, key, _objectSpread2(_defineProperty({}, path, oldVal), this.oldStateByVM[key]))); // 缓存 vm 和 watch
...
var defineReactive = function defineReactive(_ref2) {
  ...
  Object.defineProperty(obj, key, _objectSpread2({}, COMMON_PROP, {
    get: function get() {
      // 正在依赖收集
      if (Dep.targetCb) {
        // 当前属性被依赖
...
var bindComputed = function bindComputed(vm, computed, asyncSetData) {
  ...
  Object.keys(computed).forEach(function (key) {
    ...
    var oldValStr;
    var isInit = true;
    Object.defineProperty($computed, key, _objectSpread2({}, COMMON_PROP, {
      get: function get() {
        // 正在依赖收集
        if (Dep.targetCb) {
          // 当前属性被依赖
...
var TuaComp = function TuaComp(_ref) {
  ...
  return Component(_objectSpread2({}, rest, {
    methods: _objectSpread2({}, methods, {
      $emit: $emit
    }),
    properties: _objectSpread2({}, properties, {}, getPropertiesFromProps(props)),
    ...
    attached: function attached() {
      ...
      bindData(this, _objectSpread2({}, this.data, {}, data), observeDeep); // 遍历观察 computed
